...
local get_format_on_save_opts = function()
  ...
  if type(luanvim.format_on_save) ~= "table" then
    return defaults
  end

  return {
    pattern = luanvim.format_on_save.pattern or defaults.pattern,
    timeout = luanvim.format_on_save.timeout or defaults.timeout,
  }
end
...
function M.enable_format_on_save()
  ...
  vim.api.nvim_create_autocmd("BufWritePre", {
    ...
    callback = function()
      require("config.lsp.utils").format { timeout_ms = opts.timeout, filter = opts.filter }
    end,
  })
...
function M.configure_format_on_save()
  if type(luanvim.format_on_save) == "table" and luanvim.format_on_save.enabled then
    M.enable_format_on_save()
  elseif luanvim.format_on_save == true then
    M.enable_format_on_save()
  else
...
function M.enable_reload_config_on_save()
  ...
  vim.api.nvim_create_augroup("luanvim_reload_config_on_save", {})
  vim.api.nvim_create_autocmd("BufWritePost", {
    group = "luanvim_reload_config_on_save",
    pattern = pattern,
    desc = "Trigger LuanVimReload on saving config.lua",
    callback = function()
